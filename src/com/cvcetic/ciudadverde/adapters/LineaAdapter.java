...
public class LineaAdapter extends BaseAdapter {
	...
	public LineaAdapter(Context context, List<Punto> linea) {
		super();
		this.linea = linea;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View vista = inflater.inflate(R.layout.itemparadabus, null, true);
		TextView dir = (TextView) vista.findViewById(R.id.direccionparada);
		Log.d("DebugAdapter",
				String.format(
						"Se va introducir Linea %s en la vista item del adapter",
						linea.get(position).getDireccion()));
		dir.setText(linea.get(position).getDireccion());
		
		TextView dist = (TextView) vista.findViewById(R.id.distancia);
